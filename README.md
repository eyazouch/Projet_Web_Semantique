...
aNom, aPrenom: Identifient une Personne (xsd)
aAge, aDateNaissance: Données démographiques (xsd, xsd)
aPoids, aTaille, aGroupeSanguin: Données médicales basiques (xsd, xsd)
aTemperature: Mesure de température corporelle (xsd)
aDosage, aFrequence: Informations sur les médicaments (xsd)
aDateDebut, aDateFin: Période de traitement (xsd)
...
Personne équivalente à foaf: Alignement avec le standard FOAF
Patient équivalent à fhir: Compatibilité avec le standard FHIR
Medicament équivalent à fhir: Interopérabilité avec les systèmes de santé
DossierMedical équivalent à fhir: Conformité aux normes médicales
Etablissement équivalent à schema: Standardisation des organisations
...
sparqlPREFIX med: <http://www.ontologie-medicale.fr/onto#>
